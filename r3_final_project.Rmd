...
## Yufei: (Stength 1) The renaming makes the table very easy to understand!
d2_raw <- d2 %>%
...
## Yufei: (strength 2) having this redundant way at first and then introducing the function method is really a good strategy to convince people that writing functions is super helpful
```
...
## Yufei: (strength 3) these example functions are very straightforward to understand. they are really good examples for people who start to learn writing functions
```
...
## Yufei: (improvement) maybe you can generate a table to present the descriptives? It might be easier to read.

## Yufei: (one thing I learned) This introduction set up a great example for how to use the real research data to teach r. By reading the codes I learned how to make clear explanation to pragramming step by step.
```